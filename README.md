...
- Поиск и фильтрация карточек на главной странице
...
Карта построена на `MapLibre GL`, а подложка берётся из OpenStreetMap raster tiles. На главной странице отображаются подготовленные маркеры регионов.
